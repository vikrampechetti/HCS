 ...
 *
 */
public class PublishAmbulancesData {
	...
	private static void run() throws ConfigurationException, JSONException {
		...
		String offendersDataInput=configuration.getProperty("Ambulances").toString();
		...
		String response=createDataSourceRecord.createDataSourceRecord(config.AmbulancesDataSourceId(), payload.toString());
