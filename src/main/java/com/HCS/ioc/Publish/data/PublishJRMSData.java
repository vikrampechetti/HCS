...
public class PublishJRMSData {
	...
	private static void run() throws ConfigurationException, JSONException {
		...
		String offendersDataInput = configuration.getProperty("JRMS").toString();
		...
		String response = createDataSourceRecord.createDataSourceRecord(config.JRMSDataSourceId(), payload.toString());
